package com.example.boardpractice.mybatis;
...
//        SqlSessionFactorybuilder 설정파일을 제공하면 SqlSessionFactory를 만들어 줬었다
//        그리고 SqlSessionFactory객체를 사용하여 SqlSession객체를 꺼내 사용했었다

//        spring에서는 SqlSessionFactory객체도 Bean으로 만들어 스프링 컨테이너가 관리하도록 한다
//        SqlSessionFactoryBean 객체에 설정을 해주면 팩토리를 지어주는 SqlSessionFactoryBuilder의 역활을 숭하며
        //그렇게 만드러진 SqlSessionFactory를 스프링 컨테너가 관리하게 된다
//
